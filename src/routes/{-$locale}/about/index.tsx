...
function AboutPage() {
  return (
    <div class="interior-wireframe">
        ...
        <div class="about-copy-panel">
          ...
          <T>
            <p>
              ...
              like to build websites and open-source libraries. I'll probably
              post about all of the above from time to time.
            </p>
          </T>
          <T>
            <p>
          ...
          <T>
            <p>
              I'm currently a student at Brigham Young University in Provo,
              where I'm pursuing a major in ACME (Applied and Computational
              Mathematics) and a minor in Arabic. I'm also a research assistant
              in the PCCL (Perception, Control, and Cognition Lab) at BYU, where
              I study novel applications of artificial intelligence and Natural
              Language Processing.
            </p>
          </T>
        </div>
      ...
      <section class="about-facts-panel">
        <T>
        ...
        <T>
          <ul class="list-disc space-y-3 font-serif text-lg text-ink-soft leading-[1.7] font-light">
            <li>
