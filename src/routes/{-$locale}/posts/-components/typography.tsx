  ...
  return (
    <div
      class={[
        ...
        "[&_pre]:relative [&_pre]:mt-6 [&_pre]:mb-6 [&_pre]:overflow-x-auto [&_pre]:rounded-sm [&_pre]:border [&_pre]:border-border [&_pre]:bg-muted [&_pre]:p-4 [&_pre]:font-mono [&_pre]:text-sm [&_pre]:border-l-3 [&_pre]:border-l-lavender-deep",
