        ...
        >
          {!world ? (
            ...
            <svg
              ref={svgRef}
              role="img"
              aria-labelledby="lds-heatmap-title"
              viewBox={`0 0 ${W} ${H}`}
              ...
              <g id="g">
                ...
                {world.features.map((f) => {
                  ...
                  const nextTip = data
                    ...
                    : { name };
                  return (
                    // biome-ignore lint/a11y/noStaticElementInteractions: SVG regions expose hover and focus tooltips; they are not clickable controls.
                    <path
                      key={id}
                      tabIndex={isUS ? -1 : 0}
                      aria-label={name}
